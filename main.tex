...
\begin{figure*}
	...
	\includegraphics[width=0.6\linewidth]{media/diagrams/message-send-fsm.png}
...
% marginnote explaining the reasoning behind some stuff cause it's empty
\begin{itemize}
