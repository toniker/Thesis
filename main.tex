...
\chapter{Εισαγωγή}
\section{Διαστημικές Αποστολές}
Από τα τέλη της δεκαετίας του 1950, η ανθρωπότητα στράφηκε προς το διάστημα ως πηγή νέων επιστημονικών μελετών. Από τότε, δορυφόροι, τηλεσκόπια και επανδρωμένοι σταθμοί στο διάστημα έχουν προσφέρει γνώσεις ανεκτίμητης αξίας. Ανέκαθεν, το διαστημικό περιβάλλον είναι αφιλόξενο και γεμάτο προκλήσεις, που δεν συναντούμε στην Γη. Από τα πρώτα δευτερόλεπτα της αποστολής, το σύστημα πρέπει να αντέξει τις έντονες δονήσεις και την πίεση που συναντά στην εκτόξευση. Στη συνέχεια, σκαρφαλώντοντας την ατμόσφαιρα, το σύστημα θα αποσυμπιεστεί έως ότου φτάσει πρακτικά μηδενική πίεση. Λόγω του κενού αέρος, δεν υπάρχει αποδοτικός τρόπος διάδοσης της θερμότητας του συστήματος. Με αυτά τα δεδομένα είναι συνετό ότι τα διαστημικά συστήματα πρέπει εξετάζονται σε ακραίες συνθήκες θερμοκρασίας, πίεσης και μηχανικών δυνάμεων. Παρά τις αυστηρές προδιαγραφές και ενδελεχείς δοκιμές, ένα σημαντικό ποσοστό διαστημικών αποστολών καταλήγουν σε αποτυχία. Ένα πολύ γνωστό παράδειγμα αποτυχίας είναι του \emph{Space Shuttle Challenger}, το οποίο εξερράγη κατά την εκτόξευση. Στο περιστατικό έχασαν την ζωή τους οι επτά άνθρωποι που βρίσκοταν στο διαστημόπλοιο. Η αναφορά της NASA που αναλύει το συμβάν έδειξε ότι το πρόβλημα ήταν στη στεγανοποίηση ενός %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Μη-επανδρωμένοι δορυφόροι}
\section{Νανοδορυφόροι}
\section{Ο νανοδορυφόρος AcubeSAT}
...
\section{Ενσωματωμένα συστήματα}
...
Από αυτά τα πρωτόκολλα επιλέχθηκε το \acs{CAN}, για τρείς βασικούς λόγους. Ο πρώτος λόγος είναι η ισχυρή αξιοπιστία του πρωτοκόλλου, ο δεύτερος είναι η άμεση επικοινωνία των υποσυστημάτων σε κοινό μέσο και ο τρίτος είναι η υποστήριξη του πρωτοκόλλου από τους κατασκευαστές των μικροελεγκτών του δορυφόρου, Microchip και STM.

\chapter{CAN Bus}
\section{Ιστορία}
\section{Χρήση}
\section{Το επίπεδο υλικού}
\section{CAN-FD}

\chapter{Σχεδίαση του νανοδορυφόρου}
\section{Έρευνα data link budget}
\section{Επιλογή πρωτοκόλλου μηνυμάτων CAN}
